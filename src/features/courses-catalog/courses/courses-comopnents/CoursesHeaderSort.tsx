...
export default function CoursesHeaderSort({
  ...
  function handleSortSelect(sortValue: string) {
    ...
    >
      ...
      <div className="relative flex flex-col gap-5  ">
        <button
          ...
          className="flex items-center justify-between rounded-[10px] border border-grayscale-100 bg-grayscale-50  px-5 py-3.75  transition-all hover:bg-grayscale-100 hover:border-grayscale-200 duration-300 cursor-pointer"
        ...
        <div
          className={`absolute top-full z-10 mt-2.5 w-full overflow-hidden rounded-[20px] border border-grayscale-200 bg-grayscale-50 shadow-[0_10px_30px_0_rgba(20,20,20,0.06)] transition-all duration-300 ${
            isOpen
              ...
              return (
                <li key={sortOption}>
                  <button
                    ...
                    className={`w-full px-9 py-7 text-left text-body-s font-medium transition ${
                      isSelected
                        ? "text-purple-500"
